...
make_instr_func(add_rm2r_b)
{
    ...
    r.val = alu_add(sign_ext(rm.val & (0xFFFFFFFF >> (32 - data_size)), data_size), sign_ext(r.val & (0xFFFFFFFF >> (32 - data_size)), data_size), data_size);
...
make_instr_func(add_i2a_b)
{
    ...
    operand_read(&r);
    operand_read(&imm);
    r.val = alu_add(sign_ext(imm.val & (0xFFFFFFFF >> (32 - data_size)), data_size), sign_ext(r.val & (0xFFFFFFFF >> (32 - data_size)), data_size), data_size);
    operand_write(&r);

...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_rm_r_short, add_rm_r, add_rm2r_b, add_rm2r_v,
    /* 0x04 - 0x07*/ add_i2a_b, add_r_i, inv, inv,
    /* 0x08 - 0x0b*/ or_r2rm_b, or_rm_r, or_r_rm_short, or_rm2r_v,
    /* 0x0c - 0x0f*/ or_i2a_b, or_i2a_v, inv, opcode_2_byte,
    /* 0x10 - 0x13*/ adc_rm_r_short, adc_rm_r, adc_rm2r_b, adc_rm2r_v,
    /* 0x14 - 0x17*/ adc_ra_i_short, adc_i2a_v, inv, inv,
    /* 0x18 - 0x1b*/ sbb_r2rm_b, sbb_r2rm_v, sbb_rm2r_b, sbb_rm2r_v,
    /* 0x1c - 0x1f*/ sbb_i2a_b, sbb_i2a_v, inv, inv,
    /* 0x20 - 0x23*/ and_rm_r_short, and_rm_r_v, and_r_rm_short, and_rm2r_v,
    /* 0x24 - 0x27*/ and_i2a_b, and_i2a_v, inv, inv,
    /* 0x28 - 0x2b*/ sub_r2rm_b, sub_rm_r, sub_rm2r_b, sub_r_rm,
    ...
    /* 0x38 - 0x3b*/ cmp_r2rm_b, cmp_rm_r, cmp_r_rm_short, cmp_r_rm,
    /* 0x3c - 0x3f*/ cmp_r_i_short, cmp_i2a_v, inv, inv,
    /* 0x40 - 0x43*/ inc_r, inc_r, inc_r, inc_r,
    /* 0x44 - 0x47*/ inc_r, inc_r, inc_r, inc_r,
    /* 0x48 - 0x4b*/ dec_r, dec_r, dec_r, dec_r,
    /* 0x4c - 0x4f*/ dec_r, dec_r, dec_r, dec_r,
    ...
    /* 0x68 - 0x6b*/ push_i_v, imul_irm2r_v, push_short, imul_i8rm2r_v,
    ...
    /* 0x84 - 0x87*/ test_rm_r_short, test_rm_r_v, inv, inv,
    ...
    /* 0xa8 - 0xab*/ test_ra_i_short, test_ra_i_v, stos_b, stos_v,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_near_i, ret_near,
...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, and_rm_i_short, sub_i2rm_b, xor_i2rm_b, cmp_rm_i_short};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, and_rm_i_v, sub_rm_i_v, xor_i2rm_v, cmp_rm};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_rm_i_v_short, or_rm_i_v_short, adc_rm_i_v_short, sbb_rm_i_v_short, and_rm_i_v_short, sub_rm_i_v_short, xor_rm_i_v_short, cmp_rm_i_v_short};
...
instr_func group_3_b_entry[8] =
    {test_rm_i_short, inv, not_rm_b, neg_rm_b, mul_rm2a_b, imul_rm2a_b, div_rm2a_b, idiv_rm2a_b};

/* 0xf7 */
instr_func group_3_v_entry[8] =
    {test_rm_i_v, inv, not_rm_v, neg_rm_v, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v};

/* 0xff */
instr_func group_5_indirect_entry[8] =
    {inc_rm, dec_rm, call_near_indirect, inv, jmp_near_indirect, inv, push_m, inv};
